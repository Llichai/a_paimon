...
/**
 * 数据文件元数据 1.0 快照版本序列化器(遗留版本)。
 *
 * <p>相比 0.9 版本,1.0 版本新增了以下字段:
 * <ul>
 *   <li>值统计列(valueStatsCols): 用于收集统计信息的值列名称列表</li>
 * </ul>
 *
 * <p>该序列化器标记为遗留版本(Legacy),表示后续版本可能有更新的格式。
 */
public class DataFileMeta10LegacySerializer implements Serializable {

    private static final long serialVersionUID = 1L;

    /** 1.0 版本的数据文件元数据模式定义,包含17个字段 */
     ...
     * 序列化单个数据文件元数据对象。
     *
     * <p>相比 0.9 版本,增加了值统计列(valueStatsCols)字段的序列化。
     *
     ...
     * 反序列化单个数据文件元数据对象。
     *
     * <p>从输入流中读取 1.0 版本格式的数据,包括值统计列字段。
     * 对于更高版本的字段(externalPath、firstRowId等),填充为 null。
     *
     * @param in 数据输入视图
